  ...
  const services = [
    {
      ...
      description:
        "We make sure every person who tries to reach you gets an answer instantly.",
      icon: MessageSquare,
      ...
      features: [
        {
          icon: MessageSquare,
          label: "AI Web Chat",
          desc: "Your 24/7 digital receptionist",
        },
        {
          icon: PhoneCall,
          label: "Missed Call Text-Back",
          desc: "The 'Safety Net' that saves every call",
        },
        {
          icon: Globe,
          label: "Google Business Integration",
          desc: "Chat with customers from search",
        },
      ],
      size: "large",
    },
    {
      ...
      description:
        "We make you the most trusted and visible name in your local market.",
      icon: Star,
      ...
      features: [
        {
          ...
          desc: "Top answer for Siri, ChatGPT, Gemini",
        },
        {
          icon: Star,
          label: "Review Automation",
          desc: "Turn customers into 5-star reviews",
        },
      ],
      size: "medium",
    },
    {
      ...
      description:
        "We handle the paperwork and follow-ups so you can focus on the work.",
      icon: Workflow,
      ...
      features: [
        {
          ...
          desc: "Get paid faster, zero friction",
        },
        {
          icon: Bell,
          label: "Smart Appointment Reminders",
          desc: "End the 'No-Show' problem",
        },
        {
          icon: Users,
          label: "Digital Rolodex (CRM)",
          desc: "One place for every contact",
        },
      ],
      size: "medium",
    },
    {
      ...
      description:
        "Your phone never goes unanswered. AI handles calls like a pro.",
      icon: Phone,
      ...
      features: [
        {
          ...
          desc: "Answers, books, qualifies",
        },
        {
          icon: Phone,
          label: "Voicemail Drop",
          desc: "Leave messages instantly",
        },
        {
          icon: MessageSquare,
          label: "Call Recording & Transcription",
          desc: "Every conversation saved",
        },
      ],
      size: "medium",
    },
    {
      ...
      description:
        "Stop wasting money on clicks. We build ads that start conversations.",
      icon: Megaphone,
      ...
      features: [
        {
          ...
          desc: "AI-optimized campaigns",
        },
        {
          icon: Search,
          label: "Google Ads Management",
          desc: "Show up when they search",
        },
        {
          icon: MessageSquare,
          label: "Social Media Posting",
          desc: "Automated content everywhere",
        },
      ],
      size: "large",
    },
    {
      ...
      description:
        "Your business runs itself. Leads flow, messages send, deals close.",
      icon: Bot,
      ...
      features: [
        {
          ...
          desc: "Leads move automatically",
        },
        {
          icon: MessageSquare,
          label: "2-Way SMS Conversations",
          desc: "Text from one number",
        },
        {
          icon: Star,
          label: "Reputation Management",
          desc: "Monitor all reviews in one place",
        },
      ],
      size: "medium",
    },
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground font-['Space_Grotesk'] text-lg max-w-2xl mx-auto">
            Everything you need to capture leads, build reputation, and automate
            your business.
          </p>
        </motion.div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="flex items-start gap-4 mb-6">
                <div
                  className={`p-3 rounded-xl bg-gradient-to-br ${service.color} group-hover:scale-110 transition-transform`}
                >
