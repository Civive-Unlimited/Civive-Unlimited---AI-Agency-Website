    ...
    <section className="relative min-h-screen overflow-hidden pt-24 sm:pt-28">
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="grid min-h-[calc(100vh-96px)] items-center gap-14 py-10 lg:grid-cols-[minmax(0,1fr)_minmax(420px,0.88fr)] lg:gap-12">
          ...
          >
            <div className="homepage-panel relative overflow-hidden rounded-[1.65rem] p-5 sm:p-6">
              ...
              <div className="grid gap-5 pt-5">
                ...
                <div className="flex items-center justify-between gap-3 rounded-[1.1rem] border border-[oklch(0.33_0.05_228/0.42)] bg-[rgba(7,10,17,0.78)] px-4 py-3">
                  ...
                  <span className="text-sm text-[oklch(0.75_0.18_220)]">Queued immediately</span>
                </div>
              </div>
            </div>
          </motion.div>
