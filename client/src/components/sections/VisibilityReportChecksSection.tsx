...
import { visibilityReportChecks } from "@/content/site";

export default function VisibilityReportChecksSection() {
          ...
          >
            <div className="max-w-xl">
              ...
              <h2 className="mt-5 text-3xl font-semibold leading-tight text-white sm:text-4xl md:text-5xl">
                The public signals that decide whether you are easy to
                recommend.
              </h2>
              <p className="mt-6 text-base leading-7 text-white/64 sm:text-lg">
                The visibility report is not a vague AI report. It looks at the
                real places where buyers, Google, maps, voice assistants, and
                answer engines try to understand your business.
              </p>
              <a
            ...
            <div className="divide-y divide-white/[0.08] border-y border-white/[0.08]">
              {visibilityReportChecks.map((item, index) => (
                <motion.div
                  key={item.title}
                  initial={false}
                  animate={isInView ? { opacity: 1, y: 0 } : {}}
