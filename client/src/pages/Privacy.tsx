    ...
    <>
      ...
      <main className="homepage-shell legal-page min-h-screen py-24 text-foreground">
        <div className="container mx-auto max-w-3xl px-4">
          ...
          <p>Civive Unlimited ("we," "us," or "our") respects your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website, submit a form, request an audit, book an appointment, purchase a software subscription, or communicate with us by email, phone, or text message.</p>

          <h2 className="mt-8 text-xl font-semibold text-foreground">Information We Collect</h2>
          <p>We may collect personal information that you voluntarily provide when you fill out our contact forms, request a complimentary audit, book an appointment, purchase a software subscription, or contact us directly. This may include your name, email address, phone number, business name, billing contact details, subscription selection, and any message content you submit.</p>
          <p>Payments are processed by Stripe. We do not store full card numbers on our website. Stripe may collect payment, billing, fraud-prevention, and transaction information according to its own privacy terms.</p>
