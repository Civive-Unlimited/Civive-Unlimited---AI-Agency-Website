...
export const contactPageFaqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. AI search visibility and lead response are connected. If the business already gets calls, forms, or chats but loses leads through slow response, include that in the request so Civive can route the next step correctly.",
  },
];
