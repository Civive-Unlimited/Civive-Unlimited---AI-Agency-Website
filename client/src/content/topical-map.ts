...
const coreTopicalPages: TopicalPage[] = [
  {
    ...
    conversionGoal:
      "Move qualified local service businesses toward the audit fit request.",
    relatedPaths: [
  ...
  },
  {
    ...
    conversionGoal:
      "Move Springfield service business owners toward an AI growth audit-fit request.",
    parentPath: "/",
    relatedPaths: [
      "/service-areas/springfield-mo",
      "/ai-search-report",
  ...
  },
  {
    ...
    conversionGoal:
      "Convert qualified visitors into a plan discussion or audit fit request.",
  ...
  },
  {
    ...
    pageType: "conversion",
    searchIntent: "Contact, booking, and audit fit request intent",
    topicalRole:
...
const serviceTopicalPages: TopicalPage[] = servicePages.map(service => ({
  ...
  conversionGoal:
    "Move qualified service business owners toward an audit fit request or call.",
  parentPath: "/",
...
const articleTopicalPages: TopicalPage[] = resourceArticles.map(article => ({
  ...
  conversionGoal:
    "Move readers from education into an audit fit request, visibility-system review, or contact path.",
  parentPath: "/resources",
  relatedPaths: Array.from(
    new Set([
