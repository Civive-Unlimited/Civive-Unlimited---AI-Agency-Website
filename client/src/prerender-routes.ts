...
const legalMeta = {
  privacy: {
    ...
    description:
      "Privacy Policy for Civive Unlimited, including website, audit fit request, booking, email, phone, CRM, and SMS communication practices.",
  },
  terms: {
...
export const prerenderRoutes: PrerenderRoute[] = [
  ...
  },
  {
    ...
    schemaKind: "service",
    serviceName: "Audit Fit Pre-Check",
  },
  {
